...
export default function WidgetSettings({navigation}: Props) {
  ...
  const handleAddWidget = async (type: 'full' | 'toggle' | 'addnote' | 'tracking' | 'habits' | 'food' | 'nag') => {
        ...
        {available && (
          <>
            ...
            <View style={styles.addRow}>
              ...
              <TouchableOpacity style={styles.addBtn} onPress={() => handleAddWidget('nag')}>
                <Text style={styles.addBtnText}>{t('widgets.addNag')}</Text>
              </TouchableOpacity>
            </View>
          </>
        )}
